...
@property (readonly) uint16_t calibrationReady;
@property (readonly) uint16_t calibrationStart;
@property (readonly) uint16_t calibrationEnd;
@property (readonly) uint16_t calibrationDebounce;
@property (readonly) uint32_t currentSpindownTicks;
@property (readonly) uint16_t updateRateCalibration;
...
+ (NSData * _Nullable)setSpindownTimeCommandData:(NSData * _Nonnull)systemId seconds:(NSTimeInterval)seconds error:(NSError * _Nullable * _Nullable)error;
